...
```{r metricplot16396, fig.cap="Scatter plot of rating curve estimated flows against measured flows at station 16396"}
...
```{r metricplot16397, fig.cap="Scatter plot of rating curve estimated flows against measured flows at station 16397"}
## plot rating curve results
df_16397 %>%
  mutate(predicted = set_units(predicted, "ft^3/s")) %>%
  ggplot() +
...
```{r metricplot16882, fig.cap="Scatter plot of rating curve estimated flows against measured flows at station 16882"}
## plot rating curve results
df_16882_2020_03 %>%
